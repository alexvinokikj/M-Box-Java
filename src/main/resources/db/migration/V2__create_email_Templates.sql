...
INSERT INTO public.email_template(body, created_by, date_created, date_modified, modified_by, name, subject)
	VALUES ('<h3>Dear [NAME],</h3> <h3>You have registered an account on M Box.</h3> <h3> <a href="[APPURL]">Click here to verify your account.</a> </h3><br> <h3>Regards, </h3>  <h3>M Box</h3>', -1,'2018-08-27 00:00:00', NULL, -1, 'verificationMail', 'MBox Verification Mail');
